...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'express@hustcoco7.onmicrosoft.com',
  ...
  title: "ExpressCompany's OneDrive",
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/ExpressCompany/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
